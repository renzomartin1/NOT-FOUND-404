...
def home():
    ...
    try:
        response = requests.get(API_URL + 'hoteles', params={'fecha_entrada': fecha_entrada, 'fecha_salida': fecha_salida, 'cantidad_personas': cantidad_personas})
...
def hotel(hotel_id, fecha_entrada=None, fecha_salida=None, cantidad_personas=None): 
    ...
    try:
        response = requests.get(API_URL + 'hoteles/' + str(hotel_id), params={'fecha_entrada': fecha_entrada, 'fecha_salida': fecha_salida, 'cantidad_personas': cantidad_personas})
        response.raise_for_status()
